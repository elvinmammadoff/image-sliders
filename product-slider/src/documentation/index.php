...
<head>
    ...
    <!-- Title -->
    <title>Documentation - Product Slider</title>
    ...
    <div id="container" class="row">
        ...
        <div id="main-content" class="large-9 large-pull-3 columns">
            ...
            <section id="introduction" class="section" data-magellan-destination="introduction">
                ...
                <h1>Howdy!</h1>
                <p class="lead">You are a shining owner of a regular license based on Product Slider.</p>
...
-------------------------------------------------- */
  ...
  - Initial release
            ...
            <footer>
                <p>© Documentation - Product Slider</p>
            </footer>
