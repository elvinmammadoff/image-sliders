...
<html class="no-js" lang="">
    <head>
        ...
        <!-- Title -->
        <title>Documentation - Product Hero Slider</title>
            ...
            <div class="row">
              ...
              <div class="large-10 large-centered columns">
                  ...
                  <ul class="meta">
                      ...
                      <li><strong>Live Preview:</strong> <a href="https://peppy-fudge-cee13a.netlify.app/product-slider">View Demo</a></li>
            ...
            <div id="container" class="row">
                ...
                <div id="main-content" class="large-9 large-pull-3 columns">
                    ...
                    <section id="introduction" class="section" data-magellan-destination="introduction">
                          ...
                          <h1>Howdy!</h1>
                          <p class="lead">You are a shining owner of a regular license based on Product Hero Slider.</p>
...
<pre>
  ...
  - Initial release
                    ...
                    <footer>
                      <p>© Documentation - Product Hero Slider</p>
                    </footer>
